    ...
    <nav>
      <div className="wrap nav-in">
        ...
        <div className="nav-links">
          ...
          <a href={APP_LOGIN_URL} style={{ color: 'var(--navy)', fontWeight: 600 }} onClick={() => trackClick('nav_sign_in', 'Sign in')}>Sign in</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <a className="btn btn-primary" href={APP_SIGNUP_URL} onClick={() => trackClick('nav_start_trial', 'Start free trial')}>Start free trial</a>
      ...
      <div className={'mobile-panel' + (open ? ' open' : '')}>
        ...
        <a href={APP_LOGIN_URL} onClick={() => trackClick('mobile_nav_sign_in', 'Sign in')}>Sign in</a>
      </div>
    </nav>
  );
}
